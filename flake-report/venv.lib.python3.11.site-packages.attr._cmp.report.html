...
<html>
   <head>
      <title>flake8 violations: venv/lib/python3.11/site-packages/attr/_cmp.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.11.site-packages.attr._cmp.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.11.site-packages.attr._cmp.source.html#l95">
                  <tt><i>95</i>             <span class="n">msg</span> <span class="o">=</span> <span class="s2">&quot;eq must be define is order to complete ordering from lt, le, gt, ge.&quot;</span></tt>
               </a>
            </li>
            </ul>
         </li>
