...
<html>
   <head>
      <title>flake8 violations: venv/lib/python3.11/site-packages/PIL/ImageDraw2.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.11.site-packages.PIL.ImageDraw2.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.11.site-packages.PIL.ImageDraw2.source.html#l109">
                  <tt><i>109</i> <span class="sd">        Same as :py:meth:`~PIL.ImageDraw2.Draw.arc`, but connects the end points</span></tt>
               </a>
            </li><li>
               
               <p>Line too long (81 > 79 characters):</p>
               
               <a href="venv.lib.python3.11.site-packages.PIL.ImageDraw2.source.html#l134">
                  <tt><i>134</i> <span class="sd">        Same as arc, but also draws straight lines between the end points and the</span></tt>
               </a>
            </li>
            </ul>
         </li>
