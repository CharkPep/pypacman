...
<html>
   <head>
      <title>flake8 violations: venv/lib/python3.11/site-packages/_pytest/config/compat.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.lib.python3.11.site-packages._pytest.config.compat.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.lib.python3.11.site-packages._pytest.config.compat.source.html#l52">
                  <tt><i>52</i>                             <span class="n">pylib_path_arg</span><span class="o">=</span><span class="n">fspath_var</span><span class="p">,</span> <span class="n">pathlib_path_arg</span><span class="o">=</span><span class="n">path_var</span></tt>
               </a>
            </li>
            </ul>
         </li>
